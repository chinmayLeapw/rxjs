...
describe('bufferTime operator', function () {
    ...
    it('should handle throw', function () {
        testScheduler.run(function (_a) {
            ...
            var e1 = rxjs_1.throwError(function () { return new Error('haha'); });
            var expected = '#';
            var t = time('----------|');
            var result = e1.pipe(operators_1.bufferTime(t, null, Infinity, testScheduler));
    ...
    it('should not mutate the buffer on reentrant next', function () {
        testScheduler.run(function (_a) {
            ...
            var t2 = time(' --|');
            var expected = '--(a|)';
            var result = subject.pipe(operators_1.bufferTime(t2), operators_1.tap(function () { return subject.next(2); }), operators_1.take(1));
            testScheduler.schedule(function () { return subject.next(1); }, t1);
