...
describe('pairwise operator', function () {
    ...
    it('should be recursively re-enterable', function () {
        ...
        subject.pipe(operators_1.pairwise(), operators_1.take(3)).subscribe(function (pair) {
            results.push(pair);
            subject.next('c');
        });
        subject.next('a');
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.pairwise(), operators_1.take(2)).subscribe(function () {
        });
