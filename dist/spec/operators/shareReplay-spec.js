...
describe('shareReplay', function () {
    ...
    it('should only subscribe once each with multiple synchronous subscriptions and unsubscriptions ', function () { return __awaiter(void 0, void 0, void 0, function () {
        var subscriptions, source;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    subscriptions = 0;
                    source = rxjs_1.defer(function () {
                        ++subscriptions;
                        return new rxjs_1.BehaviorSubject(1);
                    }).pipe(operators_1.shareReplay({ bufferSize: 1, refCount: true }));
                    return [4, rxjs_1.firstValueFrom(rxjs_1.combineLatest([source, source]))];
                case 1:
                    _a.sent();
                    chai_1.expect(subscriptions).to.equal(1);
                    return [2];
