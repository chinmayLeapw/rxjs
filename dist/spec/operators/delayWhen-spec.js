...
describe('delayWhen', function () {
    ...
    it('should raise error if selector throws', function () {
        testScheduler.run(function (_a) {
            ...
            var result = e1.pipe(operators_1.delayWhen((function (x) {
                throw err;
            })));
    ...
    it('should complete when duration selector returns synchronous observable', function () {
        ...
        var complete = false;
        rxjs_1.of(1)
            .pipe(operators_1.delayWhen(function () { return rxjs_1.of(2); }))
            .subscribe({ next: function () { return (next = true); }, complete: function () { return (complete = true); } });
    ...
    it('should call predicate with indices starting at 0', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(result.pipe(operators_1.tap({
                complete: function () {
    ...
    it('should delayWhen Promise resolves', function (done) {
        ...
        e1.pipe(operators_1.delayWhen(function () { return Promise.resolve(42); })).subscribe({
            next: function (x) {
    ...
    it('should raise error when Promise rejects', function (done) {
        ...
        e1.pipe(operators_1.delayWhen(function (x) { return (x === 3 ? Promise.reject(error) : Promise.resolve(42)); })).subscribe({
            next: function (x) {
                chai_1.expect(x).to.equal(expected.shift());
            },
            error: function (err) {
