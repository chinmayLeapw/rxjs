...
describe('raceWith operator', function () {
    ...
    it('should allow observable emits immediately', function (done) {
        ...
        e1.pipe(operators_1.raceWith(e2)).subscribe({
            next: function (x) {
    ...
    it('should ignore latter observables if a former one errors immediately', function () {
        ...
        var onSubscribe = sinon.spy();
        var e1 = rxjs_1.throwError(function () { return 'kaboom'; });
        var e2 = rxjs_1.defer(onSubscribe);
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.raceWith(rxjs_1.of(0)), operators_1.take(3)).subscribe(function () {
        });
