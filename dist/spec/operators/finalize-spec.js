...
describe('finalize', function () {
    ...
    it('should call finalize upon disposal', function (done) {
        var disposed = false;
        var subscription = rxjs_1.timer(100)
            .pipe(operators_1.finalize(function () {
    ...
    it('should handle empty', function () {
        var testScheduler = new testing_1.TestScheduler(observableMatcher_1.observableMatcher);
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  (^!)';
            var expected = '|   ';
            var result = e1.pipe(operators_1.finalize(function () { return (executed = true); }));
    ...
    it('should handle interop source observables', function () {
        var finalized = false;
        var subscription = interop_helper_1.asInteropObservable(rxjs_1.NEVER)
            .pipe(operators_1.finalize(function () { return (finalized = true); }))
            .subscribe();
        subscription.unsubscribe();
    ...
    it('should finalize sources before sinks', function () {
        var finalized = [];
        rxjs_1.of(42)
            .pipe(operators_1.finalize(function () { return finalized.push('source'); }), operators_1.finalize(function () { return finalized.push('sink'); }))
            .subscribe();
    ...
    it('should finalize after the finalization', function () {
        ...
        var source = new rxjs_1.Observable(function () {
            return function () { return order.push('finalizer'); };
        });
    ...
    it('should finalize in the proper order', function () {
        var results = [];
        rxjs_1.of(1)
            .pipe(operators_1.finalize(function () { return results.push(1); }), operators_1.finalize(function () { return results.push(2); }), operators_1.finalize(function () { return results.push(3); }), operators_1.finalize(function () { return results.push(4); }))
            .subscribe();
