...
describe('find', function () {
    ...
    it('should return matching element from source emits single element', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.find(predicate))).toBe(expected, values);
    ...
    it('should work with a custom thisArg', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.find(predicate, finder))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should return undefined if element does not match with predicate', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.find(predicate))).toBe(expected, { x: undefined });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should allow unsubscribing early and explicitly', function () {
        testScheduler.run(function (_a) {
            ...
            var expected = '-------     ';
            var unsub = '   ------!     ';
            var result = e1.pipe(operators_1.find(function (value) { return value === 'z'; }));
    ...
    it('should not break unsubscription chains when result is unsubscribed explicitly', function () {
        testScheduler.run(function (_a) {
            ...
            var expected = '-------     ';
            var unsub = '   ------!     ';
            var result = e1.pipe(operators_1.mergeMap(function (x) { return rxjs_1.of(x); }), operators_1.find(function (value) { return value === 'z'; }), operators_1.mergeMap(function (x) { return rxjs_1.of(x); }));
            expectObservable(result, unsub).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should unsubscribe when the predicate is matched', function () {
        testScheduler.run(function (_a) {
            ...
            var t = time('    --|       ');
            var expected = '-------(b|) ';
            var result = e1.pipe(operators_1.find(function (value) { return value === 'b'; }), operators_1.delay(t));
    ...
    it('should support type guards without breaking previous behavior', function () {
        {
            ...
            var foo = new Foo();
            rxjs_1.of(foo)
                .pipe(operators_1.find(function (foo) { return foo.baz === 42; }))
            ...
            var foobar = new Foo();
            rxjs_1.of(foobar)
                .pipe(operators_1.find(function (foobar) { return foobar.bar === 'name'; }))
                .subscribe(function (x) { return x.bar; });
            rxjs_1.of(foobar)
                .pipe(operators_1.find(isBar))
                .subscribe(function (x) { return x.bar; });
            ...
            rxjs_1.of(barish)
                .pipe(operators_1.find(function (x) { return x.bar === 'quack'; }))
                .subscribe(function (x) { return x.bar; });
            rxjs_1.of(barish)
                .pipe(operators_1.find(isBar))
        ...
        }
        {
            ...
            xs.pipe(operators_1.find(isString)).subscribe(function (s) { return s.length; });
            xs.pipe(operators_1.find(function (x) { return typeof x === 'number'; })).subscribe(function (x) { return x; });
            xs.pipe(operators_1.find(function (x, i) { return typeof x === 'number' && x > i; })).subscribe(function (x) { return x; });
        }
    });
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.find(function (value) { return value === 2; })).subscribe(function () {
        });
