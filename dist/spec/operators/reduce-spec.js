...
describe('reduce', function () {
    ...
    it('should reduce', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  ^----------!   ';
            var expected = '-----------(x|)';
            var result = e1.pipe(operators_1.reduce(function (o, x) { return o + x; }, 0));
    ...
    it('should reduce with seed', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  ^-------!   ';
            var expected = '--------(x|)';
            var result = e1.pipe(operators_1.reduce(function (o, x) { return o + ' ' + x; }, 'n'));
    ...
    it('should reduce with a seed of undefined', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '     ^--------------------!   ';
            var expected = '   ---------------------(x|)';
            var result = e1.pipe(operators_1.reduce(function (o, x) { return o + ' ' + x; }, undefined));
    ...
    it('should reduce without a seed', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '     ^--------------------!   ';
            var expected = '   ---------------------(x|)';
            var result = e1.pipe(operators_1.reduce(function (o, x) { return o + ' ' + x; }));
    ...
    it('should reduce with index without seed', function () {
        var idx = [1, 2, 3, 4, 5];
        rxjs_1.range(0, 6)
            .pipe(operators_1.reduce(function (acc, value, index) {
    ...
    it('should reduce with seed if source is empty', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '     ^-------!   ';
            var expected = '   --------(x|)';
            var result = e1.pipe(operators_1.reduce(function (o, x) { return o + x; }, '42'));
    ...
    it('should raise error if reduce function throws without seed', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  ^----!   ';
            var expected = '-----#   ';
            var result = e1.pipe(operators_1.reduce(function () {
                throw 'error';
            }));
    ...
    it('should not break unsubscription chains when result is unsubscribed explicitly', function () {
        testScheduler.run(function (_a) {
            ...
            var expected = '-------  ';
            var unsub = '   ------!  ';
            var result = e1.pipe(operators_1.mergeMap(function (x) { return rxjs_1.of(x); }), operators_1.reduce(function (o, x) { return o + x; }), operators_1.mergeMap(function (x) { return rxjs_1.of(x); }));
            expectObservable(result, unsub).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
