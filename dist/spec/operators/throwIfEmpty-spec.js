...
describe('throwIfEmpty', function () {
    ...
    describe('with errorFactory', function () {
        it('should error when empty', function () {
            rxTestScheduler.run(function (_a) {
                ...
                var source = cold('----|');
                var expected = '   ----#';
                var result = source.pipe(operators_1.throwIfEmpty(function () { return new Error('test'); }));
        ...
        it('should throw if empty', function () {
            ...
            var thrown;
            rxjs_1.EMPTY.pipe(operators_1.throwIfEmpty(function () { return error; })).subscribe({
                error: function (err) {
                    thrown = err;
                },
            });
        ...
        it('should NOT throw if NOT empty', function () {
            ...
            var thrown;
            rxjs_1.of('test')
                .pipe(operators_1.throwIfEmpty(function () { return error; }))
                .subscribe({
                error: function (err) {
                    thrown = err;
                },
        ...
        it('should throw if empty after retry', function () {
            ...
            source
                .pipe(operators_1.throwIfEmpty(function () { return error; }), operators_1.mergeMap(function (value) {
                if (value > 1) {
                    return rxjs_1.throwError(function () { return new Error(); });
                }
    ...
    describe('without errorFactory', function () {
        ...
        it('should throw if empty after retry', function () {
            ...
            source
                .pipe(operators_1.throwIfEmpty(), operators_1.mergeMap(function (value) {
                if (value > 1) {
                    return rxjs_1.throwError(function () { return new Error(); });
                }
                return rxjs_1.of(value);
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.throwIfEmpty(), operators_1.take(3)).subscribe(function () {
        });
