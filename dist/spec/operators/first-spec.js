...
describe('first', function () {
    ...
    it('should allow undefined as a default value', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  ^-------------!   ';
            var expected = '--------------(U|)';
            expectObservable(e1.pipe(operators_1.first(function (value) { return value === 'b'; }, undefined))).toBe(expected, { U: undefined });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should error on empty', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '     ^----!';
            var expected = '   -----#';
            expectObservable(e1.pipe(operators_1.first())).toBe(expected, null, new rxjs_1.EmptyError());
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    ...
    it('should return first value that matches a predicate', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '    ^-----!         ';
            var expected = '  ------(c|)      ';
            expectObservable(e1.pipe(operators_1.first(function (value) { return value === 'c'; }))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should return first value that matches a predicate for odd numbers', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '    ^-----!         ';
            var expected = '  ------(c|)      ';
            expectObservable(e1.pipe(operators_1.first(function (x) { return x % 2 === 1; }))).toBe(expected, { c: 3 });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should error when no value matches the predicate', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '    ^--------------!';
            var expected = '  ---------------#';
            expectObservable(e1.pipe(operators_1.first(function (x) { return x === 's'; }))).toBe(expected, null, new rxjs_1.EmptyError());
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should return the default value when no value matches the predicate', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '    ^--------------!   ';
            var expected = '  ---------------(d|)';
            expectObservable(e1.pipe(operators_1.first(function (x) { return x === 's'; }, 'd'))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should propagate error when no value matches the predicate', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '    ^-----------!';
            var expected = '  ------------#';
            expectObservable(e1.pipe(operators_1.first(function (x) { return x === 's'; }))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should return first value that matches the index in the predicate', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '    ^--------!      ';
            var expected = '  ---------(a|)   ';
            expectObservable(e1.pipe(operators_1.first(function (_, i) { return i === 2; }))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should propagate error from predicate', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.first(predicate))).toBe(expected, null, 'error');
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should support type guards without breaking previous behavior', function () {
        {
            ...
            rxjs_1.of(foo)
                .pipe(operators_1.first(function (foo) { return foo.bar === 'name'; }))
                .subscribe(function (x) { return x.baz; });
            rxjs_1.of(foo)
            ...
            rxjs_1.of(foobar)
                ...
                .subscribe(function (x) { return x.bar; });
            rxjs_1.of(foobar)
                .pipe(operators_1.first(function (foobar) { return foobar.bar === 'name'; }))
                .subscribe(function (x) { return x.bar; });
            rxjs_1.of(foobar)
            ...
            rxjs_1.of(barish)
                ...
                .subscribe(function (x) { return x.baz; });
            rxjs_1.of(barish)
                .pipe(operators_1.first(function (x) { return x.bar === 'quack'; }))
                .subscribe(function (x) { return x.bar; });
            rxjs_1.of(barish)
                .pipe(operators_1.first(isBar))
                .subscribe(function (x) { return x.bar; });
        }
        {
            ...
            xs.pipe(operators_1.first(isString)).subscribe(function (s) { return s.length; });
            xs.pipe(operators_1.first(function (x) { return typeof x === 'string'; })).subscribe(function (x) { return x; });
        }
    });
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.first(function (value) { return value === 2; })).subscribe(function () {
        });
