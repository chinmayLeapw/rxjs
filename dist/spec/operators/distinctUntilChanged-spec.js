...
describe('distinctUntilChanged', function () {
    ...
    it('should distinguish between values', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.distinctUntilChanged())).toBe(expected);
    ...
    it('should emit once if comparator returns true always regardless of source emits', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  ^-------------------!';
            var expected = '--a-----------------|';
            var comparator = function () { return true; };
            expectObservable(e1.pipe(operators_1.distinctUntilChanged(comparator))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should emit all if comparator returns false always regardless of source emits', function () {
        testScheduler.run(function (_a) {
            ...
            var comparator = function () { return false; };
            expectObservable(e1.pipe(operators_1.distinctUntilChanged(comparator))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should distinguish values by comparator', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.distinctUntilChanged(comparator))).toBe(expected, { a: 1, c: 3, e: 5 });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    ...
    it('should use the keySelector to pick comparator values', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.distinctUntilChanged(comparator, keySelector))).toBe(expected, { a: 1, b: 2, d: 4, f: 6 });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should use the keySelector even for the first emit', function () {
        testScheduler.run(function (_a) {
            ...
            var expected = '--a-----|';
            var keySelector = function (x) { return x % 2; };
            expectObservable(e1.pipe(operators_1.distinctUntilChanged(null, keySelector))).toBe(expected, { a: 2 });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should raise error when keySelector throws', function () {
        testScheduler.run(function (_a) {
            ...
            expectObservable(e1.pipe(operators_1.distinctUntilChanged(null, keySelector))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.distinctUntilChanged(), operators_1.take(3)).subscribe(function () {
        });
