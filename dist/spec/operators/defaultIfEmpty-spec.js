...
describe('defaultIfEmpty', function () {
    ...
    it('should allow undefined as a default value', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '  ^-------!';
            var expected = '--------(U|)';
            expectObservable(e1.pipe(operators_1.defaultIfEmpty(undefined))).toBe(expected, { U: undefined });
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.defaultIfEmpty(0), operators_1.take(3)).subscribe(function () {
        });
