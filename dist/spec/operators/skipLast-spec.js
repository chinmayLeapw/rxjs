...
describe('skipLast operator', function () {
    ...
    it('should propagate error from the source observable', function () {
        testScheduler.run(function (_a) {
            ...
            var e1subs = '   ^---!';
            var expected = ' ----#';
            expectObservable(e1.pipe(operators_1.skipLast(42))).toBe(expected, null, 'too bad');
            expectSubscriptions(e1.subscriptions).toBe(e1subs);
        });
    });
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.skipLast(1), operators_1.take(3)).subscribe(function () {
        });
