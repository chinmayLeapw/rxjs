...
describe('withLatestFrom', function () {
    ...
    it('should handle promises', function (done) {
        rxjs_1.of(1)
            .pipe(operators_1.delay(1), operators_1.withLatestFrom(Promise.resolve(2), Promise.resolve(3)))
            .subscribe({
            next: function (x) {
    ...
    it('should handle arrays', function () {
        rxjs_1.of(1)
            .pipe(operators_1.delay(1), operators_1.withLatestFrom([2, 3, 4], [4, 5, 6]))
    ...
    it('should handle lowercase-o observables', function () {
        rxjs_1.of(1)
            .pipe(operators_1.delay(1), operators_1.withLatestFrom(test_helper_1.lowerCaseO(2, 3, 4), test_helper_1.lowerCaseO(4, 5, 6)))
            .subscribe(function (x) {
            chai_1.expect(x).to.deep.equal([1, 4, 6]);
        });
    });
