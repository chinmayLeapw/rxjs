...
describe('repeat operator', function () {
    ...
    it('should always finalization before starting the next cycle', function () { return __awaiter(void 0, void 0, void 0, function () {
        var results, source;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4, source.pipe(operators_1.repeat(3)).forEach(function (value) { return results.push(value); })];
                case 1:
                    _a.sent();
                    chai_1.expect(results).to.deep.equal([1, 2, 'finalizer', 1, 2, 'finalizer', 1, 2, 'finalizer']);
                    return [2];
            }
        });
    }); });
    it('should always finalize before starting the next cycle, even when synchronous', function () {
        ...
        chai_1.expect(results).to.deep.equal([1, 2, 'finalizer', 1, 2, 'finalizer', 1, 2, 'complete', 'finalizer']);
    });
    ...
    it('should repeat a synchronous source (multicasted and refCounted) multiple times', function (done) {
        ...
        rxjs_1.of(1, 2, 3)
            .pipe(operators_1.multicast(function () { return new rxjs_1.Subject(); }), operators_1.refCount(), operators_1.repeat(5))
            .subscribe({
            next: function (x) {
    ...
    it('should stop listening to a synchronous observable when unsubscribed', function () {
        ...
        synchronousObservable.pipe(operators_1.repeat(), operators_1.take(3)).subscribe(function () {
        });
    ...
    it('should allow count configuration', function () {
        rxTest.run(function (_a) {
            ...
            var expected = '--a--b----a--b----a--b--|';
            expectObservable(e1.pipe(operators_1.repeat({ count: 3 }))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(subs);
        });
    });
    it('should allow delay time configuration', function () {
        rxTest.run(function (_a) {
            ...
            var expected = '--a--b-------a--b-------a--b--|';
            expectObservable(e1.pipe(operators_1.repeat({ count: 3, delay: delay }))).toBe(expected);
            expectSubscriptions(e1.subscriptions).toBe(subs);
        });
    });
    it('should allow delay function configuration', function () {
        rxTest.run(function (_a) {
            ...
            var expected = '--a--b-------a--b-------a--b--|';
            expectObservable(e1.pipe(operators_1.repeat({
                count: 3,
