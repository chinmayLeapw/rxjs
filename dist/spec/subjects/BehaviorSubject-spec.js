...
describe('BehaviorSubject', function () {
    ...
    it('should replay the previous value when subscribed', function () {
        testScheduler.run(function (_a) {
            ...
            var subscriber1 = hot('------(a|)                         ').pipe(operators_1.mergeMapTo(behaviorSubject));
            var unsub1 = '         ---------------------!             ';
            var expected1 = '      ------3---4------5-6--             ';
            var subscriber2 = hot('------------(b|)                   ').pipe(operators_1.mergeMapTo(behaviorSubject));
            var unsub2 = '         -------------------------!         ';
            var expected2 = '      ------------4----5-6---7--         ';
            var subscriber3 = hot('---------------------------(c|)    ').pipe(operators_1.mergeMapTo(behaviorSubject));
            var expected3 = '      ---------------------------8---9--|';
