...
describe('SafeSubscriber', function () {
    ...
    it('should chain interop unsubscriptions', function () {
        ...
        subscriber.add(function () { return subscriberUnsubscribed = true; });
        var source = new rxjs_1.Observable(function () { return function () { return observableUnsubscribed = true; }; });
        var subscription = source.subscribe(interop_helper_1.asInteropSubscriber(subscriber));
        subscription.add(function () { return subscriptionUnsubscribed = true; });
    ...
    it('should have idempotent unsubscription', function () {
        var count = 0;
        var subscriber = new Subscriber_1.SafeSubscriber();
        subscriber.add(function () { return ++count; });
    ...
    it('should close, unsubscribe, and unregister all finalizers after complete', function () {
        ...
        var subscriber = new Subscriber_1.SafeSubscriber();
        subscriber.add(function () { return isUnsubscribed = true; });
        subscriber.complete();
        chai_1.expect(isUnsubscribed).to.be.true;
        chai_1.expect(subscriber.closed).to.be.true;
        chai_1.expect(subscription_1.getRegisteredFinalizers(subscriber).length).to.equal(0);
    });
    it('should close, unsubscribe, and unregister all finalizers after error', function () {
        ...
        subscriber.add(function () { return isTornDown = true; });
...
describe('Subscriber', function () {
    it('should finalize and unregister all finalizers after complete', function () {
        ...
        subscriber.add(function () { isTornDown = true; });
        subscriber.complete();
        chai_1.expect(isTornDown).to.be.true;
        chai_1.expect(subscription_1.getRegisteredFinalizers(subscriber).length).to.equal(0);
    });
