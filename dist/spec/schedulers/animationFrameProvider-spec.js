...
describe('animationFrameProvider', function () {
    ...
    it('should be monkey patchable', function () {
        ...
        var handle = animationFrameProvider_1.animationFrameProvider.requestAnimationFrame(function () {
        });
        animationFrameProvider_1.animationFrameProvider.cancelAnimationFrame(handle);
