...
describe('TestScheduler', function () {
    ...
    describe('parseMarbles()', function () {
        it('should parse a marble string into a series of notifications and types', function () {
            ...
            chai_1.expect(result).deep.equal([
                { frame: 70, notification: NotificationFactories_1.nextNotification('A') },
                { frame: 110, notification: NotificationFactories_1.nextNotification('B') },
                { frame: 150, notification: NotificationFactories_1.COMPLETE_NOTIFICATION }
            ]);
        });
        it('should parse a marble string, allowing spaces too', function () {
            var result = testing_1.TestScheduler.parseMarbles('--a--b--|   ', { a: 'A', b: 'B' });
            chai_1.expect(result).deep.equal([
                { frame: 20, notification: NotificationFactories_1.nextNotification('A') },
                { frame: 50, notification: NotificationFactories_1.nextNotification('B') },
                { frame: 80, notification: NotificationFactories_1.COMPLETE_NOTIFICATION }
            ]);
        });
        it('should parse a marble string with a subscription point', function () {
            var result = testing_1.TestScheduler.parseMarbles('---^---a---b---|', { a: 'A', b: 'B' });
            chai_1.expect(result).deep.equal([
                { frame: 40, notification: NotificationFactories_1.nextNotification('A') },
                { frame: 80, notification: NotificationFactories_1.nextNotification('B') },
                { frame: 120, notification: NotificationFactories_1.COMPLETE_NOTIFICATION }
            ]);
        });
        it('should parse a marble string with an error', function () {
            ...
            chai_1.expect(result).deep.equal([
                { frame: 70, notification: NotificationFactories_1.nextNotification('A') },
                { frame: 110, notification: NotificationFactories_1.nextNotification('B') },
                { frame: 150, notification: NotificationFactories_1.errorNotification('omg error!') }
            ]);
        });
        it('should default in the letter for the value if no value hash was passed', function () {
            ...
            chai_1.expect(result).deep.equal([
                { frame: 20, notification: NotificationFactories_1.nextNotification('a') },
                { frame: 50, notification: NotificationFactories_1.nextNotification('b') },
                { frame: 80, notification: NotificationFactories_1.nextNotification('c') },
            ]);
        });
        it('should handle grouped values', function () {
            var result = testing_1.TestScheduler.parseMarbles('---(abc)---');
            chai_1.expect(result).deep.equal([
                { frame: 30, notification: NotificationFactories_1.nextNotification('a') },
                { frame: 30, notification: NotificationFactories_1.nextNotification('b') },
                { frame: 30, notification: NotificationFactories_1.nextNotification('c') }
            ]);
        });
        it('should ignore whitespace when runMode=true', function () {
            ...
            chai_1.expect(result).deep.equal([
                { frame: 10, notification: NotificationFactories_1.nextNotification('A') },
                { frame: 30, notification: NotificationFactories_1.nextNotification('B') },
                { frame: 50, notification: NotificationFactories_1.nextNotification('C') },
                { frame: 60, notification: NotificationFactories_1.COMPLETE_NOTIFICATION }
            ]);
        });
        it('should support time progression syntax when runMode=true', function () {
            ...
            chai_1.expect(result).deep.equal([
                { frame: 10.2, notification: NotificationFactories_1.nextNotification('A') },
                { frame: 10.2 + 10 + (1.2 * 1000), notification: NotificationFactories_1.nextNotification('B') },
                { frame: 10.2 + 10 + (1.2 * 1000) + 10 + (1000 * 60), notification: NotificationFactories_1.nextNotification('C') },
                { frame: 10.2 + 10 + (1.2 * 1000) + 10 + (1000 * 60) + 10, notification: NotificationFactories_1.COMPLETE_NOTIFICATION }
            ]);
        });
        it('should support emoji characters', function () {
            var result = testing_1.TestScheduler.parseMarbles('--🙈--🙉--🙊--|');
            chai_1.expect(result).deep.equal([
                { frame: 20, notification: NotificationFactories_1.nextNotification('🙈') },
                { frame: 50, notification: NotificationFactories_1.nextNotification('🙉') },
                { frame: 80, notification: NotificationFactories_1.nextNotification('🙊') },
                { frame: 110, notification: NotificationFactories_1.COMPLETE_NOTIFICATION }
            ]);
        });
    });
    describe('parseMarblesAsSubscriptions()', function () {
        ...
        it('should throw if found more than one subscription point', function () {
            chai_1.expect(function () { return testing_1.TestScheduler.parseMarblesAsSubscriptions('---^-^-!-'); }).to.throw();
        });
    ...
    describe('TestScheduler.run()', function () {
        ...
        describe('animate', function () {
            it('should throw if animate() is not called when needed', function () {
                var testScheduler = new testing_1.TestScheduler(assertDeepEquals);
                chai_1.expect(function () { return testScheduler.run(function () {
                    animationFrameProvider_1.animationFrameProvider.schedule(function () { });
                }); }).to.throw();
            });
            it('should throw if animate() is called more than once', function () {
                var testScheduler = new testing_1.TestScheduler(assertDeepEquals);
                chai_1.expect(function () { return testScheduler.run(function (_a) {
            ...
            it('should schedule async requests within animate()', function () {
                ...
                testScheduler.run(function (_a) {
                    ...
                    testScheduler.schedule(function () {
                        schedule(function (t) { return values.push("a@" + t); });
                        chai_1.expect(values).to.deep.equal([]);
                    }, 0);
                    testScheduler.schedule(function () {
                        schedule(function (t) { return values.push("b@" + t); });
                        chai_1.expect(values).to.deep.equal([]);
                    }, 1);
                    testScheduler.schedule(function () {
            ...
            it('should support request cancellation within animate()', function () {
                ...
                testScheduler.run(function (_a) {
                    ...
                    var schedule = animationFrameProvider_1.animationFrameProvider.schedule;
                    testScheduler.schedule(function () {
                        var subscription = schedule(function (t) { return values.push("a@" + t); });
                        schedule(function (t) { return values.push("b@" + t); });
        ...
        describe('immediate and interval', function () {
            ...
            it('should support clearing immediates', function () {
                ...
                testScheduler.run(function () {
                    var values = [];
                    var setImmediate = immediateProvider_1.immediateProvider.setImmediate, clearImmediate = immediateProvider_1.immediateProvider.clearImmediate;
            ...
            it('should schedule intervals', function () {
                ...
                testScheduler.run(function () {
                    var values = [];
                    var setInterval = intervalProvider_1.intervalProvider.setInterval, clearInterval = intervalProvider_1.intervalProvider.clearInterval;
        ...
        describe('schedulers', function () {
            it('should support animationFrame, async and asap schedulers', function () {
                var testScheduler = new testing_1.TestScheduler(assertDeepEquals);
                testScheduler.run(function (_a) {
                    var animate = _a.animate, cold = _a.cold, expectObservable = _a.expectObservable, time = _a.time;
                    animate('            ---------x');
                    var mapped = cold('--m-------');
                    var tb = time('      -----|  ');
                    var expected = '   --(dc)-b-a';
                    var result = mapped.pipe(operators_1.mergeMap(function () { return rxjs_1.merge(rxjs_1.of('a').pipe(operators_1.delay(0, rxjs_1.animationFrameScheduler)), rxjs_1.of('b').pipe(operators_1.delay(tb, rxjs_1.asyncScheduler)), rxjs_1.of('c').pipe(operators_1.delay(0, rxjs_1.asyncScheduler)), rxjs_1.of('d').pipe(operators_1.delay(0, rxjs_1.asapScheduler))); }));
            ...
            it('should emit asap notifications before async notifications', function () {
                ...
                testScheduler.run(function (_a) {
                    ...
                    var mapped = cold('--ab------');
                    var expected = '   ---(ba)---';
                    var result = mapped.pipe(operators_1.mergeMap(function (value) { return value === 'a'
                        ? rxjs_1.of(value).pipe(operators_1.delay(1, rxjs_1.asyncScheduler))
                        : rxjs_1.of(value).pipe(operators_1.delay(0, rxjs_1.asapScheduler)); }));
                    expectObservable(result).toBe(expected);
                });
            });
            it('should support intervals with zero duration', function () {
                ...
                testScheduler.run(function (_a) {
                    ...
                    var mapped = cold('--m-------');
                    var expected = '   --(bbbaaa)';
                    var result = mapped.pipe(operators_1.mergeMap(function () { return rxjs_1.merge(rxjs_1.interval(0, rxjs_1.asyncScheduler).pipe(operators_1.mapTo('a'), operators_1.take(3)), rxjs_1.interval(0, rxjs_1.asapScheduler).pipe(operators_1.mapTo('b'), operators_1.take(3))); }));
                    expectObservable(result).toBe(expected);
                });
            });
        });
