...
describe('iif', function () {
    ...
    it('should subscribe to thenSource when the conditional returns true', function () {
        rxTestScheduler.run(function (_a) {
            ...
            var e1 = rxjs_1.iif(function () { return true; }, rxjs_1.of('a'), rxjs_1.of());
            var expected = '(a|)';
    ...
    it('should complete without an elseSource when the conditional returns false', function () {
        rxTestScheduler.run(function (_a) {
            var expectObservable = _a.expectObservable;
            var e1 = rxjs_1.iif(function () { return false; }, rxjs_1.of('a'), rxjs_1.of());
            var expected = '|';
            expectObservable(e1).toBe(expected);
        });
    });
    ...
    it('should accept resolved promise as thenSource', function (done) {
        var expected = 42;
        var e1 = rxjs_1.iif(function () { return true; }, new Promise(function (resolve) {
            resolve(expected);
        }), rxjs_1.of());
        e1.subscribe({
            next: function (x) {
    ...
    it('should accept resolved promise as elseSource', function (done) {
        var expected = 42;
        var e1 = rxjs_1.iif(function () { return false; }, rxjs_1.of('a'), new Promise(function (resolve) {
            resolve(expected);
        }));
        e1.subscribe({
            next: function (x) {
    ...
    it('should accept rejected promise as elseSource', function (done) {
        var expected = 42;
        var e1 = rxjs_1.iif(function () { return false; }, rxjs_1.of('a'), new Promise(function (resolve, reject) {
            reject(expected);
        }));
        e1.subscribe({
            next: function (x) {
    ...
    it('should accept rejected promise as thenSource', function (done) {
        var expected = 42;
        var e1 = rxjs_1.iif(function () { return true; }, new Promise(function (resolve, reject) {
            reject(expected);
        }), rxjs_1.of());
        e1.subscribe({
            next: function (x) {
