    ...
    describe('multiplex', function () {
        ...
        it('should keep the same socket for multiple multiplex subscriptions', function () {
            ...
            var sub1 = socketSubject.multiplex(function () { return 'no-op'; }, function () { return results.push('A unsub'); }, function (req) { return req.id === 'A'; }).pipe(operators_1.takeWhile(function (req) { return !req.complete; }))
                .subscribe({ next: function () { return results.push('A next'); }, error: function (e) { return results.push('A error ' + e); }, complete: function () { return results.push('A complete'); } });
            socketSubject.multiplex(function () { return 'no-op'; }, function () { return results.push('B unsub'); }, function (req) { return req.id === 'B'; })
                .subscribe({ next: function () { return results.push('B next'); }, error: function (e) { return results.push('B error ' + e); }, complete: function () { return results.push('B complete'); } });
            var socket = MockWebSocket.lastSocket;
            socket.open();
        ...
        it('should not close the socket until all subscriptions complete', function () {
            ...
            socketSubject.multiplex(function () { return 'no-op'; }, function () { return results.push('A unsub'); }, function (req) { return req.id === 'A'; }).pipe(operators_1.takeWhile(function (req) { return !req.complete; })).subscribe({ next: function () { return results.push('A next'); }, error: function (e) { return results.push('A error ' + e); }, complete: function () { return results.push('A complete'); } });
            socketSubject.multiplex(function () { return 'no-op'; }, function () { return results.push('B unsub'); }, function (req) { return req.id === 'B'; }).pipe(operators_1.takeWhile(function (req) { return !req.complete; })).subscribe({ next: function () { return results.push('B next'); }, error: function (e) { return results.push('B error ' + e); }, complete: function () { return results.push('B complete'); } });
            var socket = MockWebSocket.lastSocket;
            socket.open();
