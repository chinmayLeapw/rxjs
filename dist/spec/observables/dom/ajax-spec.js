...
var root = (typeof globalThis !== 'undefined' && globalThis) || (typeof self !== 'undefined' && self) || global;
...
describe('ajax', function () {
    ...
    it('should raise an error if not able to create XMLHttpRequest', function () {
        ...
        ajax_1.ajax(obj).subscribe({ error: function (err) { return chai_1.expect(err).to.exist; } });
    });
    ...
    it('should raise an error if not able to create CORS request', function () {
        ...
        ajax_1.ajax(obj).subscribe({
            error: function (err) { return chai_1.expect(err).to.exist; },
        });
    });
    ...
    describe('ajax XSRF cookie in custom header', function () {
        ...
        it('should send the cookie cross-domain with a custom header when withCredentials is set', function () {
            ...
            ajax_1.ajax(obj).subscribe();
            var request = MockXMLHttpRequest.mostRecent;
            chai_1.expect(request.url).to.equal('https://some.subresource.net/some/page');
            chai_1.expect(request.requestHeaders).to.deep.equal({
                'Custom-Header-Name': 'bar',
            });
        });
    ...
    it('should not alter user-provided X-Requested-With header, even if crossDomain is true', function () {
        ...
        var request = MockXMLHttpRequest.mostRecent;
        chai_1.expect(request.requestHeaders['x-requested-with']).to.equal('Custom-XMLHttpRequest');
    });
    ...
    it('should return an object that allows access to response headers', function () {
        ...
        ajax_1.ajax({
            ...
            chai_1.expect(response.responseHeaders).to.deep.equal(sentResponseHeaders);
        });
        var mockXHR = MockXMLHttpRequest.mostRecent;
        mockXHR.respondWith({
            status: 200,
        ...
        chai_1.expect(mockXHR.getAllResponseHeaders()).to.equal("content-type: application/json\nx-custom-header: test\nx-headers-are-fun: <whatever/> {\"weird\": \"things\"}");
    });
    describe('with queryParams', function () {
        ...
        it('should not screw things up if there is an existing search string in the url passed', function () {
            ...
            chai_1.expect(mockXHR.url).to.equal('/whatever?jays_face=is+a+param&lol=haha&foo=bar&whatever=123');
        });
        it('should overwrite existing args from existing search strings in the url passed', function () {
            ...
            chai_1.expect(mockXHR.url).to.equal('/whatever?terminator=2&uncle_bob=...okayyyyyyy&movie_quote=yes');
        });
        it('should properly encode values', function () {
            ...
            chai_1.expect(mockXHR.url).to.equal('/whatever?this+is+a+weird+param+name=%3F%23*+value+here+rofl+%21%21%21');
        });
        it('should handle dictionaries that have numbers, booleans, and arrays of numbers, strings or booleans', function () {
            ...
            chai_1.expect(mockXHR.url).to.equal('/whatever?a=123&b=true&c=one%2Ctwo%2Cthree&d=1%2C3%2C3%2C7&e=true%2Cfalse%2Ctrue');
        });
...
var MockXHREventTarget = (function () {
    ...
    MockXHREventTarget.prototype.removeEventListener = function (type, handler) {
        var _a;
        (_a = this.registry.get(type)) === null || _a === void 0 ? void 0 : _a.delete(handler);
    };
    ...
    MockXMLHttpRequest.prototype.getAllResponseHeaders = function () {
        return this._responseHeaders
            ? Object.entries(this._responseHeaders)
                .map(function (entryParts) { return entryParts.join(': '); })
                .join('\n')
            : '';
    };
    MockXMLHttpRequest.prototype.respondWith = function (response, config) {
        var _a, _b;
        var _c = config !== null && config !== void 0 ? config : {}, _d = _c.uploadProgressTimes, uploadProgressTimes = _d === void 0 ? 0 : _d, _e = _c.downloadProgressTimes, downloadProgressTimes = _e === void 0 ? 0 : _e;
        ...
        this.triggerEvent('load', { type: 'load', total: (_a = response.total) !== null && _a !== void 0 ? _a : 0, loaded: (_b = response.loaded) !== null && _b !== void 0 ? _b : 0 });
