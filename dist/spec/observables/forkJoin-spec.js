...
describe('forkJoin', function () {
    ...
    it('should support a resultSelector with an Array of ObservableInputs', function () {
        var results = [];
        rxjs_1.forkJoin([rxjs_1.of(1, 2, 3), rxjs_1.of(4, 5, 6), rxjs_1.of(7, 8, 9)], function (a, b, c) { return a + b + c; }).subscribe({
            next: function (value) {
                results.push(value);
            },
            error: function (err) {
    ...
    it('should finalize in the proper order', function () {
        var results = [];
        var source = rxjs_1.forkJoin([1, 2, 3, 4].map(function (n) {
            return rxjs_1.timer(100, rxTestScheduler).pipe(rxjs_1.map(function () { return n; }), rxjs_1.finalize(function () { return results.push("finalized " + n); }));
        }));
        source.subscribe(function (value) { return results.push(value); });
        rxTestScheduler.flush();
        chai_1.expect(results).to.deep.equal(['finalized 1', 'finalized 2', 'finalized 3', 'finalized 4', [1, 2, 3, 4]]);
    });
