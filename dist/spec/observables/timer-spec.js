...
describe('timer', function () {
    ...
    it('should create an observable emitting periodically', function () {
        rxTest.run(function (_a) {
            ...
            var e1 = rxjs_1.timer(6, 2, rxTest).pipe(operators_1.take(4), operators_1.concat(rxjs_1.NEVER));
    ...
    it('should start after delay and periodically emit values', function () {
        rxTest.run(function (_a) {
            ...
            var source = rxjs_1.timer(dueTime, period, rxTest).pipe(operators_1.take(5));
    ...
    it('should still target the same date if a date is provided even for the ' + 'second subscription', function () {
        rxTest.run(function (_a) {
